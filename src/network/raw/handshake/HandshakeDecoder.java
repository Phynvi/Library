...
/**
 * The {@code HandshakeDecoder} will receive any incoming data from a client
 * with the same port and decode the first requests made by the client. The
 * {@code HandshakeDecoder} will reply differently based on the request of the
 * RuneScape Client.
 * 
 * <p>
 * To see the different types of requests, view
 * {@link network.raw.handshake.HandshakeRequest}
 * 
...
public class HandshakeDecoder extends ByteToMessageDecoder {
    ...
    /**
     * Decodes the 'handshake' process between the client and this server from
     * the specified incoming {@code ByteBuf}.
     * 
     * @param ctx
