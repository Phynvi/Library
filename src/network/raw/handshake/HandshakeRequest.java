...
public enum HandshakeRequest {
    ...
    /**
     * This type of request requires the server to send update information to
     * the client.
     */
    UPDATE(15);
    ...
    /**
     * Constructs a new {@code HandshakeRequest} from the specified
     * {@code requestId}.
     * 
     * @param requestId
    ...
    /**
     * Finds the specific {@code HandshakeRequest} for the specified {@code id},
     * and will return {@code null} if it does not exist.
     * 
     * @param id
     *            the id of the request to retrieve
     * @return the retrieved {@code HandshakeRequest} if existing; return
     *         {@code null} otherwise
     */
