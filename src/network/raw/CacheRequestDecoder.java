...
/**
 * The {@code CacheRequestDecoder} will decode any information from the client
 * when it requests information from the cache. The {@code CacheRequestDecoder}
 * will respond by sending the information of the cache.
 * 
...
public class CacheRequestDecoder extends ByteToMessageDecoder {
    ...
    /**
     * Constructs a new {@code CacheRequestDecoder} with the specified
     * {@code handler}, which will handle the cache response to the client.
     * 
     * @param handler
    ...
    /**
     * Decodes the cache request that the client has sent the server. The
     * information from the cache must be sent back.
     * 
     * @param ctx
     *            the context decoded
     * @param in
