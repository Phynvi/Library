...
/**
 * This class holds important, static information for the Network of this
 * Library. It is important to register a {@code RawHandler} that will handle
 * the revision type of a server.
 * 
...
public final class NetworkRepository {
    ...
    /**
     * Registers the specified {@code RawHandler} to this
     * {@code NetworkRepository} for static access to the specified
     * {@code handler}.
     * 
    ...
    /**
     * Returns the static {@code RawHandler} registered within this
     * {@code NetworkRepository} based on the specified {@code revision}, or
     * null if it does not exist.
     * 
     * @param revision
     *            the revision of the {@code RawHandler}
     * @return the raw handler based on the revision; or null if it doesn't
     *         exist
     */
