...
/**
 * A {@code ConnectionHolder} implementation is meant to hold a {@code Connection} value by the
 * {@link ConnectionHolder#getConnection()} method.
 * 
...
public interface ConnectionHolder {
	...
	/**
	 * Returns the {@code Display} of the {@code Connection} within this {@code ConnectionHolder}.
	 * 
	 * @return the display
	 */
