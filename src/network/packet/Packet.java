...
/**
 * A {@code Packet} contains bytes of data which contains information for the server or client to
 * determine any actions based on the data.
 * 
...
public abstract class Packet {
	...
	/**
	 * Constructs a new {@code Packet} with the specified {@code opcode} that has a default
	...
	/**
	 * Constructs a new {@code Packet}, which is represented as a <b>raw packet</b>, with a default
	 * opcode of -1.
	 */
	public Packet() {
		this(-1);
