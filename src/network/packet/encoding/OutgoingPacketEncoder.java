...
/**
 * The {@code OutgoingPacketEncoder} takes any {@code EncodedPacket} being sent
 * through the network from the server to the client and re-writes the
 * information for the client to read plainly.
 * 
...
public class OutgoingPacketEncoder extends MessageToByteEncoder<EncodedPacket> {
    ...
    /**
     * Encodes any {@code EncodedPacket} being sent through the network from the
     * server to the client and re-writes the information for the client to read
     * plainly.
     */
