...
/**
 * This type of {@code Packet} is used for encoding data so the client can read
 * it.
 * 
...
public class EncodedPacket extends Packet {
    ...
    /**
     * Constructs a new {@code EncodedPacket} with the specified {@code opcode}
     * and {@code type}.
     * 
     * @param type
     *            the type of packet
    ...
    /**
     * Constructs a new {@code EncodedPacket} with the specified {@code opcode}
     * with a default type of {@link PacketType#STANDARD}.
     * 
     * @param opcode
     *            the opcode of this packet
     */
    ...
    /**
     * Constructs a new {@code EncodedPacket}, which is represented as a <b>raw
     * packet</b>, with a default opcode of -1 and default type of
    ...
    /**
     * Writes the bytes of the specified {@code packet} to this
     * {@code EncodedPacket}.
     * 
     * @param packet
    ...
    /**
     * Writes the bytes of the specified {@code buffer} to this
     * {@code EncodedPacket}.
     * 
     * @param buffer
    ...
    /**
     * Writes the specified values of {@code b} as bytes to this
     * {@code EncodedPacket}.
     * 
     * @param b
     *            the values to write
    ...
    /**
     * Writes the specified values of {@code s} as shorts to this
     * {@code EncodedPacket}.
     * 
     * @param s
     *            the values to write
    ...
    /**
     * Writes the specified values of {@code i} as integers to this
     * {@code EncodedPacket}.
     * 
     * @param i
     *            the values to write
    ...
    /**
     * Writes the specified values of {@code l} as longs to this
     * {@code EncodedPacket}.
     * 
     * @param l
     *            the values to write
    ...
    /**
     * Writes the specified values of {@code m} as mediums to this
     * {@code EncodedPacket}.
     * 
     * @param m
     *            the values to write
    ...
    /**
     * Writes the bytes of the specified {@code string} with a trailing 0 byte
     * value to this {@code EncodedPacket}.
     * 
     * @param string
     *            the string to write
     * @return the instance of this {@code EncodedPacket} for chaining
    ...
    /**
     * Writes the bytes of the specified {@code string} with a leading and
     * trailing 0 byte value to this {@code EncodedPacket}.
     * 
     * @param string
     *            the string to write
     * @return the instance of this {@code EncodedPacket} for chaining
    ...
    /**
     * Writes a {@code String} with a trailing byte value of 0 that cannot have
     * any {@code null} value within the specified {@codes string}.
     * 
     * @param string
     *            the string to write
     * @return the instance of this {@code EncodedPacket} for chaining
    ...
    /**
     * Writes the value as a byte if the value is >= 128 otherwise it will write
     * it as a short + 32768.
     * 
     * @param b
     *            the values to write
    ...
    /**
     * Sets the bit position within this {@code EncodedPacket} to start writing
     * bit information.
     * 
     * <p>
    ...
    /**
     * Sets the writer index back to the value it was before bit information had
