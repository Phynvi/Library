...
/**
 * Represents the type of {@code Packet}, which is used for different types of
 * packet encoding.
 * 
...
public enum PacketType {
    ...
    /**
     * This type of {@code Packet} has its length written as a byte when being
     * sent to the client.
     */
    VAR_BYTE(1),

    /**
     * This type of {@code Packet} has its length written as a short when being
     * sent to the client.
     */
    VAR_SHORT(2);
