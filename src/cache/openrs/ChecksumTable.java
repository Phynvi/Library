 ...
 * a {@link Container} and prepended with the file type and id it is more commonly known as the
 * client's "update keys".
 * 
 * @author Graham
 * @author `Discardedx2
 */
public class ChecksumTable {
	...
	/**
	 * Decodes the {@link ChecksumTable} in the specified {@link ByteBuffer} and decrypts the final
	 * whirlpool hash.
	 * 
	 * @param buffer
	 *           The {@link ByteBuffer} containing the table.
	...
	/**
	 * Represents a single entry in a {@link ChecksumTable}. Each entry contains a CRC32 checksum and
	 * version of the corresponding {@link ReferenceTable}.
	 * 
