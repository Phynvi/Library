...
import cache.openrs.util.CompressionUtils;

/**
 * A {@link Container} holds an optionally compressed file. This class can be used to decompress and
 * compress containers. A container can also have a two byte trailer which specifies the version of
 * the file within it.
 * 
 * @author Graham
 * @author `Discardedx2
