...
/**
 * A {@link Sector} contains a header and data. The header contains information used to verify the
 * integrity of the cache like the current file id, type and chunk. It also contains a pointer to
 * the next sector such that the sectors form a singly-linked list. The data is simply up to 512
 * bytes of the file.
 * 
 * @author Graham
 * @author `Discardedx2
