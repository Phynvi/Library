...
/**
 * The {@link Cache} class provides a unified, high-level API for modifying the cache of a Jagex
 * game.
 * 
 * @author Graham
 * @author `Discardedx2
...
public final class Cache implements Closeable {
	...
	/**
	 * Computes the {@link ChecksumTable} for this cache. The checksum table forms part of the
	 * so-called "update keys".
	 * 
