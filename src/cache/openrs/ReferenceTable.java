...
/**
 * A {@link ReferenceTable} holds details for all the files with a single type, such as checksums,
 * versions and archive members. There are also optional fields for identifier hashes and whirlpool
 * digests.
 * 
 * @author Graham
 * @author `Discardedx2
...
public class ReferenceTable {
	...
	/**
	 * A flag which indicates this {@link ReferenceTable} contains {@link Djb2} hashed identifiers.
	 */
	...
	public ByteBuffer encode() throws IOException {
		/*
		 * we can't (easily) predict the size ahead of time, so we write to a stream and then to the
		 * buffer
		 */
