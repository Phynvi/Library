...
public enum CompressionType {
    /**
     * This compression type is used when the first byte of the block is equal
     * to 1.
     */
    NONE(0) {
	@Override
    ...
    /**
     * The {@code BZIP} compression type is used when the first byte of the
     * block is equal to 1.
     * 
     * <p>
     * This compression type will encode and decode using the BZip2
    ...
    /**
     * The {@code GZIP} compression type is used when the first byte of the
     * block is equal to 2.
     * 
     * <p>
     * This compression type will encode and decode using the GZip
     * compressing/decompressing.
     */
    GZIP(2) {
	@Override
    ...
    /**
     * Constructs a new {@code CompressionType} with a corresponding {@code id}
     * which is the correlating compression id.
     * 
     * @param id
    ...
    /**
     * Retrieves the {@code CompressionType} with the specified {@code id};
    ...
    /**
     * Decodes the given {@code bytes} argument using its compression algorithm
     * (if any) and returns the decoded bytes in a {@code ByteBuffer}.
     * 
     * @param bytes
     *            the bytes to decode
    ...
    /**
     * Encodes the given {@code bytes} argument using its compression algorithm
     * (if any) and returns the encoded bytes in a {@code ByteBuffer}.
     * 
     * @param bytes
     *            the bytes to encode
