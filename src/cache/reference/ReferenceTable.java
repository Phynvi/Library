...
public class ReferenceTable {
	...
	public boolean equals(Object o) {
		...
		if (rt.version != this.version)
			return false;
		if (rt.idx != this.idx)
			return false;
		if (rt.format != this.format)
			return false;
		if (rt.references.size() != this.references.size())
			return false;
