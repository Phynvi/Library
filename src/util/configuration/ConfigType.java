...
/**
 * Represents a util.configuration type that is written or read to or from a file
 * 
...
public enum ConfigType {
	...
	/**
	 * The Configuration which is written in plain text format, usually readable to the eye.
	 */
	TXT
