...
public class FileConfig extends ConfigSection {
	...
	/**
	 * The YML parser we use as an interface to write to the file This uses the SnakeYAML library.
	 */
	...
	/**
	 * Dumps all previous values and loads the config from the file supplied in the constructor.
	 * 
	 * @throws IOException
	...
	/**
	 * Returns what would be the contents of this FileConfig if it were written to disk, in string
	 * form.
	 */
	@Override
