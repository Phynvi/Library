...
public class DropTable<L extends LootableItem> {
	...
	public DropTable<L> addDropAlways(L item) {
		if (item == null)
			throw new IllegalArgumentException("Cannot add null item to CustomDropTable");
	 ...
	 */
	protected Collection<L> selectItems() {
