...
public final class ArrayUtil {
	...
	/**
	 * Returns true if the specified {@code Array} contains the specified {@code type} using the
	...
	/**
	 * Returns true if the specified {@code Array} contains the specified {@code type}; false is
	 * returned otherwise.
	 * 
	 * @param a
	 *           the array to search
	...
	/**
	 * Returns the index of the specified {@code o} argument within the specified {@code a} Array. If
	...
	/**
	 * Returns the {@code Array} with the specified {@code element} removed from the specified
	 * {@code a}.
	 * 
	 * @param a
	...
	/**
	 * Returns the {@code Array} with the specified {@code element} inserted at the specified
