...
public abstract class RSMap extends AreaManager implements EventListener {
    ...
    /**
     * Finds any {@code Entity} of the given class type within the specified
     * {@code bounds} and returns a {@code HashSet} of the entities found.
     * 
     * @param from
     * @param to
     * @return
    ...
    /**
     * Finds any {@code Entity} of the given class type within the specified
     * {@code radius} of the {@code location} and returns a {@code HashSet} of
     * the entities found.
     * 
     * @param location
     ...
     * @return a {@code HashSet} with any entities with the given class type are
     *         within the radius of the location
     */
