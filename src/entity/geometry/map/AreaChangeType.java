...
/**
 * Represents a type of state when an {@code Entity} changes location within an {@code Area}.
 * 
...
public enum AreaChangeType {
	...
	/**
	 * This {@code AreaChangeType} is used when an {@code Entity} has been teleported in/out of an
	 * {@code Area}.
	 */
	TELEPORT,
