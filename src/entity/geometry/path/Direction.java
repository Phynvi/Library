...
public abstract class Direction {
	...
	/**
	 * Returns true if you can walk this direction, from the given location. Eg, does this tile let you
	 * walk north?
	 * 
	 * @param from
	...
	/**
	 * Returns true if you can shoot in this direction, from the given location. Eg, does this tile let
	 * you shoot north?
	 * 
	 * @param from
	 *            the location starting from
