...
public abstract class EntityOption {
	...
	/**
	 * This flag is used to determine whether this {@code EntityOption} is placed above the "Walk"
	 * entityOption.
	 */
	...
	/**
	 * This method is called when this {@code EntityOption} has been selected on the specified
