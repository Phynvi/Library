...
public interface Actor {
	...
	/**
	 * Queues a newly created {@code Action} that executes code based on the
	 * code within the given {@code consumer} argument. This allows for quick
	 * queuing of an {@code Action}.
	 * 
	 * @param cancellable
