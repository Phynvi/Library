...
/**
 * The {@code Page} class represents a page within a dialog (written conversation). This class is
 * used by the {@link game.dialog.Dialog} class to create a written conversation used by NPCs or
...
public class Page {
	...
	/**
	 * This is the id of the npc that is talking. If an NPC is not talking and a Player is, then this
	 * value is set to -1.
	 * 
	 * <p>
	...
	/**
	 * Constructs a new {@code Page} from the specified {@code text}. If the text is null or has no
