...
public abstract class Window {
    ...
    /**
     * Sets the child id of this {@code Window} to the specified {@code id},
     * normally referred to as the interface id.
     * 
     * @return the child id
     */
    ...
    /**
     * Unlocks the specified {@code options} for the specified componentId with
    ...
    /**
     * Returns the child id of this {@code Window}, normally referred to as the
     * interface id.
     * 
     * @return the child id
     */
