...
public abstract class Interface extends Window {
	...
	/**
	 * True if the interface may be clicked on, false if it is click through (Example, some overlays
	 * like the wilderness overlay are actually interfaces, and they ignore mouse clicks).
	 */
	 ...
	 * {@code PaneHolder} of this {@code Interface}.
	 * 
