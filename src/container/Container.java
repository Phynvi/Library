...
public class Container<E extends BasicItem> implements Collection<E>, Iterable<E> {
    ...
    /**
     * Returns an index which has not been taken inside of this
     * {@code Container}.
     * 
    ...
    /**
     * Returns the maximum item stack amount an item in this {@code Container}
     * can have.
     * 
    ...
    /**
     * Returns the minimum item stack amount an item in this {@code Container}
     * can have.
     * 
